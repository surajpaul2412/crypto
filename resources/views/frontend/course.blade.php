        ...
        <div class="row px-3 pb-1">
            <div class="col-md-12 my-3">
                <div class="slider-header pt-4 pb-3 px-3">
                    ...
                    <p class="font-regular font-13">
                        VARIOUS SPECIALISED FACULTY IS ASSIGNED TO THIS COURSE.<br>EACH LECTURES IS WELL PLANNED & COURSE IS PROPERLY STRUCTURED<br>EXAMINATION & CRYPTO CIPHER MUSIC PRODUCTION CERTIFICATION
                    </p>
                    <h6 class="font-regular bold text-green pb-2 font-16">Course Fee : ₹ 60,000 + GST </h6>
                    <a href="">
            ...
            <div class="col-md-12 my-3">
                <div class="slider-header pt-4 pb-3 px-3">
                    ...
                    <h6 class="font-regular font-13"><span class="bold">SUBMISSION.</span> 2 HOURS OFFICIAL LECTURE DURATION BUT CAN EXTEND UPTO 4 HOURS DEPENDING ON TOPICS. </h6>
                    <p class="font-regular font-13">
                        VARIOUS SPECIALISED FACULTY IS ASSIGNED TO THIS COURSE.<br>WORKSHOPS, PRACTICALS & HOME EXERCISE WILL BE PROVIDED FOR ALL MODULES.<br>EACH LECTURES IS WELL PLANNED & COURSE IS PROPERLY STRUCTURED EXAMINATION & CRYPTO CIPHER SOUND ENGINEERING DIPLOMA CERTIFICATION.

                    </p>
                    <h6 class="font-regular bold text-green pb-2 font-16">Course Fee : ₹ 180,000 + GST </h6>
                    <a href="">
                        <div class="font-regular mb-2 mt-2 page-12-btn">
                            EXPLORE MORE
                        </div>
