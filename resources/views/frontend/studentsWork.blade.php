                            ...
                            <a class="nav-link {{$index == 0 ? 'active' : '' }}" href="#tab{{$index+1}}" data-toggle="tab">
                                <div class="row">
                                    <div class="col-md-4 col-5 student">
                                        <img src="{{asset('images/work/')}}/{{$row->image}}" class="d-block m-auto shadow-round" width="100%">
                                    </div>
                        ...
                        <div role="tabpanel" class="tab-pane {{$key == 0 ? 'active' : '' }}" id="tab{{$key+1}}">
                            <div class="row px-3">
                                <div class="col-md-3 py-3">
                                    <img src="{{asset('images/work/')}}/{{$row->image}}" class="d-block m-auto shadow-round" width="94%">
                                </div>
